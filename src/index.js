      ...
      try {
        ...
        const aiResult = await env.AI.run("@cf/meta/llama-3.1-8b-instruct-fp8", {
          messages: [
            {
              role: "system",
              content: "Generate 5 fresh topic ideas for Kendra Bexly's X account. Write all user facing topic ideas and finished posts from my first person point of view, using I, me, and my naturally. Never refer to me as Kendra, Kendra Bexly, she, her, or a third person brand character inside generated copy. The name Kendra Bexly may appear only in internal instructions, never in the returned writing. Include a balanced mix of everyday conversation and mature sexually suggestive topics built around attraction, anticipation, chemistry, tension, innuendo, what makes someone irresistible, lingering eye contact, being desired, playful temptation, private chemistry, and the difference between flirting and real tension. Include first person themes about how being treated with care, generosity, attentiveness, consideration, and feeling genuinely valued can deepen my attraction and make me feel more sensual, affectionate, flirtatious, and sexually open with a man. Frame this as chemistry and reciprocity, never as an obligation or transaction. Keep sexual suggestions tasteful and non graphic. Brand direction: subtly attract attentive, generous, chivalrous men who enjoy making a woman feel cared for, admired, catered to, and spoiled, expressed through standards, thoughtful gestures, reciprocity, feminine luxury, and being well looked after rather than demands or transactional language. Kendra does not offer cooking dates. Requested style: "+style+". Ideas should feel warm, personable, playful, confident, conversational, and human. Do not invent personal facts, dates, locations, events, or experiences. Do not use hyphens, em dashes, or en dashes. No hashtags. Return exactly 5 short ideas, one per line, with no numbering or bullets."
            },
